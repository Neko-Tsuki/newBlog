...
export const ru: Translation = {
	...
	[Key.animeLoadingDescription]:
		"Пожалуйста, подождите, загружаем вашу коллекцию из Bangumi",
	[Key.animeError]: "Ошибка загрузки данных",
	[Key.animeErrorDescription]:
		"Не удается подключиться к Bangumi API, пожалуйста, проверьте подключение к сети или попробуйте позже",
	...
	[Key.animeConfigDescription]:
		"Пожалуйста, установите ваш ID пользователя Bangumi в src/config/siteConfig.ts",
	[Key.animeRefreshNote]:
		"Из-за некоторых ограничений может потребоваться обновить страницу один раз для загрузки данных об аниме, пока нет хорошего решения",
