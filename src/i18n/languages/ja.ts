...
export const ja: Translation = {
	...
	[Key.animeLoadingDescription]:
		"お待ちください、Bangumiからコレクション情報を取得しています",
	[Key.animeError]: "データ読み込み失敗",
	[Key.animeErrorDescription]:
		"Bangumi APIに接続できません。ネットワーク接続を確認するか、後で再試行してください",
	[Key.animeRetry]: "再読み込み",
	[Key.animeEmptyData]: "データなし",
	[Key.animeEmptyDescription]:
		"このカテゴリには関連するアニメ作品が見つかりませんでした",
	[Key.animeEmptySuggestion]: "他のカテゴリに切り替えてみてください",
	[Key.animeConfigDescription]:
		"src/config/siteConfig.tsファイルでBangumiユーザーIDを設定してください",
	[Key.animeRefreshNote]:
		"一部の制限により、アニメデータを読み込むためにページを一度更新する必要があるかもしれません。現在、良い解決方法はありません",
