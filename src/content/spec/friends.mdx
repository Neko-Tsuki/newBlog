...
export const site = {
  name: "尘尘落落格",
  desc: "在代码的世界里修行，在幻想的境界里生活",
  url: "https://blog.shika-mori.top",
  // 友链图标统一用站点 favicon（与网站图标保持一致）
  avatar: "https://blog.shika-mori.top/favicon/icon-192.png",
  email: "bok-fiddle-rigging@duck.com",
};

{/* ========= 注意事项 ========== */}

export const notes = [
  { title: "网站类型", content: "优先互换技术分享、生活随笔或具有原创内容的个人站点" },
  { title: "稳定运营", content: "建站时间建议满三个月且有持续更新，确保站点长期有效" },
  { title: "安全要求", content: "站点需支持 HTTPS 访问，以保障访问者的安全及用户体验" },
  { title: "双向告知", content: "更改域名或撤销链接前请务必留言告知，以便同步维护调整" },
];
